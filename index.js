...
const connectKeWA = () => {
const semar = makeWASocket({logger:pino({level:'silent'}),printQRInTerminal: true,auth: state,browser: ["OBET Bot Multi Device", "Dekstop", "3.0"]})
...
else if(connection === 'open') {console.log(`RasiTech\n\n\n\n\n\nBot Simi-Simi`)}
